    ...
    <section className="border-t border-border px-4 py-16 sm:py-24">
      <div className="mx-auto max-w-6xl">
        ...
        <p className="mt-4 max-w-xl text-muted">
          ...
          a working city that listed itself on Solana. The Floor is walkable in first person. Dino
          ...
          {WORLDS.flatMap((w) =>
            w.stills.map((still) => (
              ...
              >
                ...
                <figcaption className="flex flex-col gap-0.5 px-3 py-2 sm:flex-row sm:items-center sm:justify-between sm:gap-3">
