...
export const STAGES: Record<StageId, StageTheme> = {
  1: {
    id: 1,
    name: "Dawn Grove",
    tagline: "Bright moss. Cream lanes. Warm hazards.",
    ...
    wrap: "bg-[#7ec8ea]",
    overlay: "bg-gradient-to-b from-sky-900/20 via-emerald-950/48 to-emerald-950/55",
    hud: "border-white/25 bg-emerald-950/50",
    speedBase: 4.5,
    speedRamp: 6,
    mushroomChance: 0.16,
    spawnMin: 22,
  ...
  2: {
    id: 2,
    name: "Volt Dusk",
    tagline: "Gold lanes on dusk. Faster tape.",
    ...
    wrap: "bg-[#24143c]",
    overlay: "bg-gradient-to-b from-violet-950/35 via-fuchsia-950/50 to-slate-950/60",
    hud: "border-white/20 bg-violet-950/55",
    speedBase: 5.5,
    speedRamp: 7,
    mushroomChance: 0.22,
    spawnMin: 18,
  ...
  3: {
    id: 3,
    name: "Night Tape",
    tagline: "Icy lanes. Neon edges. Max focus.",
    music: "/game/music/dino-dash-boost.mp3",
    playbackRate: 1.06,
    sky: "#070b16",
    fog: "#10182a",
    ...
    wrap: "bg-[#070b16]",
    overlay: "bg-gradient-to-b from-slate-950/40 via-slate-950/55 to-black/65",
